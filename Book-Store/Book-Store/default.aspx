...
<td runat="server" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:databaseConnectionString %>" SelectCommand="SELECT [BookName], [ListingID], [Title], [CoverImageURL], [Price], [PostingDate] FROM [Listings] ORDER BY [PostingDate] DESC">
                    </asp:SqlDataSource>
                    <br />
                </td>
            </tr>
    ...
    <div id="searchResults" runat="server">
        ...
        <br />
        <asp:ListView ID="ListView2" runat="server" DataKeyNames="ListingID" DataSourceID="SqlDataSource2" GroupItemCount="3">
            <AlternatingItemTemplate>
                <td runat="server" style="background-color:#FFF8DC;">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ViewListing.aspx?ListingID=" + Eval("ListingID") %>' Text='<%# Eval("Title") %>'></asp:HyperLink>
                    <br />
...
<td runat="server" />
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:databaseConnectionString %>" SelectCommand="SELECT [ListingID], [Title], [BookName], [CoverImageURL], [Price], [PostingDate] FROM [Listings] WHERE ([BookName] LIKE '%' + @BookName + '%') ORDER BY [PostingDate] DESC">
            <SelectParameters>
                <asp:ControlParameter ControlID="searchBox" Name="BookName" PropertyName="Text" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        <br />
